...
const lessonData = {
    ...
    numbers: [
    { id: 'lesson-1', title: 'Số 1', image: '1-10/1-Photoroom.png', description: 'Giơ ngón trỏ lên.', english: 'One', category: 'numbers' },
    { id: 'lesson-2', title: 'Số 2', image: '1-10/2-Photoroom.png', description: 'Giơ ngón trỏ và ngón giữa.', english: 'Two', category: 'numbers' },
    { id: 'lesson-3', title: 'Số 3', image: '1-10/3-Photoroom.png', description: 'Giơ ngón cái, ngón trỏ và ngón giữa.', english: 'Three', category: 'numbers' },
    { id: 'lesson-4', title: 'Số 4', image: '1-10/4-Photoroom.png', description: 'Giơ bốn ngón tay, khép ngón cái.', english: 'Four', category: 'numbers' },
...
function performDictionarySearch() { 
    ...
    // Không cần sort nữa vì đã sắp xếp đúng ý người dùng (ưu tiên bắt đầu trước)
...
function filterDictionary(category) {
    // Cập nhật trạng thái active của pill
    ...
    let filtered;
    if (category === 'all') {
        filtered = dictionaryData;
    } else {
        filtered = dictionaryData.filter(item => item.category === category);
    }
